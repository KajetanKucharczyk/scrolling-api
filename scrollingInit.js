...
scrolling({
    target: "scrolling_root",
    pages: [
      {id: "page-1", title: "Hejka", theme: "light"},
      {id: "page-2", title: "Coś o mnie", theme: "dark"},
      {id: "page-3", title: "Portfolio", theme: "light"},
      {id: "page-4", title: "Nad czym pracowałem?", theme: "dark"},
      {id: "page-5", title: "Hobby", theme: "light"},
      {id: "page-6", title: "Kontakt", theme: "dark"},
    ],
    options: {
      animationSpeed: '250',
      pageTitle: true,
